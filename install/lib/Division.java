...
public class Division extends AbstractWingElement implements StructuralElement, WingMergeableElement
{
    ...
    //added By Jayson Boubin
    /*
     * Adds a paragraph, but takes advantage of the addFigure feature of RichTextContainers
     * This method can add a paragraph which also contains an image.
     */
    public Para addParaFigure(String name, String rend, String figureSrc, String figureTrg, String figureRend) throws WingException
    {
        Para para = new Para(context, name, rend);
	para.addFigure(figureSrc, figureTrg, figureRend);
        contents.add(para);
        return para;
    }
